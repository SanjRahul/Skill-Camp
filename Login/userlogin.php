...
<body onload="getsavedcookie();">
    <div class="container lbox">
     	<div class="d-flex justify-content-center">
     		<div class="card carded" style="width: 30rem;">
            <div class="card-header cardheader">
              <h2>Sign In</h2>
            </div>
            <div class="card-body">
              <p class="card-text">
    	        <form method="post" action="/Skill_Camp/AdminLTE/Database/loginp.php">
              ...
              <input class="btn btn-primary login_btn" type="submit" name="login" id="login" value="Log In">
              </form>
            </div>
            <div class="card-footer">
				       <div class="d-flex justify-content-center links">
					        Don't have an account?<a href="Adminlogin.php">Admin Account</a>
				       </div>
				       <div class="d-flex justify-content-center">
